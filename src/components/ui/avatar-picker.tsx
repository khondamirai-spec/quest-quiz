...
export function AvatarPicker({ onAvatarSelect, selectedAvatar: propSelectedAvatar, className }: AvatarPickerProps) {
    const [internalSelectedAvatar, setInternalSelectedAvatar] = useState<Avatar>(avatars[0]);
    const [rotationCount, setRotationCount] = useState(0);

    const selectedAvatar = propSelectedAvatar || internalSelectedAvatar;

    const handleAvatarSelect = (avatar: Avatar) => {
        setRotationCount((prev) => prev + 1080); // Add 3 rotations each time
        setInternalSelectedAvatar(avatar);
